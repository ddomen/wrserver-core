...
A Websocket Rest Server for node.js

### Installing
Install this library is easy by cloning the repo. You can install trhought npm too: Local installation
...
* **[Core](https://github.com/ddomen/wrserver/tree/master/core)** => core module contains basic concepts
