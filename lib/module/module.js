...
class Module {
    ...
    digest(connection, message) {
        ...
        if (cnt) {
            return this._interceptors.intercept(cnt, [connection, message], { type: 'function', callback: (int) => int.call(this) }, { type: 'false', callback: null }, { type: 'any', callback: () => this.makeController(connection, message, cnt) }) || null;
        }
        return null;
    }
