...
class Module {
    ...
    get _interceptors() { return new component_1.InterceptorCollection(this.interceptors); }
    ...
    digest(connection, message) {
        ...
        if (cnt) {
            return this._interceptors.intercept(cnt, { type: 'function', callback: (int) => int.call(this) }, { type: 'false', callback: null }, { type: 'any', callback: () => this.makeController(connection, message, cnt) }) || null;
        }
        return null;
    }
