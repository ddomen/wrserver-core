...
class Connection {
    ...
    onParsed(message) {
        ...
        if (mod) {
            ...
            this.interceptors.intercept(mod.constructor, [message], { type: 'function', callback: (int) => int.call(this) }, { type: 'false', callback: () => null }, { type: 'any', callback: () => this.digest(mod, message) });
        }
        else {
            return this.bad('bad target');
        }
